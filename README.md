# Lisios Home Assistant Integration

Integration for Lisios WasserAlarm for Home Assistant
...
1. Add this repository to HACS: [see docs](https://www.hacs.xyz/docs/faq/custom_repositories/).
1. Search for the `Lisios` integration and add it to your Home Assistant.
